          ...
          <div>
            ...
            <StyledInfoLP>
              ...
              <div style={{width: 'calc(100% - 70px', color: '#ffffff', fontSize: 16, marginLeft: 20, marginRight: 20}}>
                <div>Add/Remove liquidity to <a style={{color: '#e0077d', textDecoration: 'none'}} href={pairLink} target="__blank"><b>{symbolShort} pair</b></a> on {protocal} to get <span style={{color: '#e0077d'}}>{lpToken}</span> tokens. Then deposit those LP tokens on farm.polkabridge.org to receive rewards</div>
                <Spacer size="sm" />
                <a style={{color: '#e0077d'}} target="__blank" href={addLiquidityLink}>
                  <b>Add Liquidity on {protocal}</b>
                </a>&nbsp;&nbsp;
                <a style={{color: '#e0077d'}} target="__blank" href={removeLiquidityLink}>
