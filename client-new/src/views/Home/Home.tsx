  ...
  return (
    <Page>
        ...
        <div style={{fontWeight: 'bold', fontSize: 22, color: '#ffffff', textAlign: 'center'}}>
            PBR Price: <span style={{color: '#e0077d', fontSize: 30}}>$<TotalLockValue /></span>
        </div>
        <div style={{fontWeight: 'bold', fontSize: 22, color: '#ffffff', textAlign: 'center'}}>
            Total Value Locked (TVL): <span style={{color: '#e0077d', fontSize: 30}}>$<TotalLockValue /></span>
        </div>
        ...
        <Box className="mt-4">
            ...
            <StyledParagraph>Earn PBR tokens by staking PBR LP token</StyledParagraph>
            <Spacer size="lg" />
            <FarmCards />
        </Box>
    </Page>
